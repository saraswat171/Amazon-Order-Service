...
export class RabbitmqConfigService {
  ...
  private config: ConfigType = {
    ...
    primaryQueue: this.configService.get<string>('RABBITMQ_SALES_QUEUE'),
    retryQueue: this.configService.get<string>('RABBITMQ_SALES_RETRY_QUEUE'),
    retryBindingKey: this.configService.get<string>(
      'RABBITMQ_SALES_RETRY_BINDING_KEY',
    ),
    errorBindingKey: this.configService.get<string>(
      'RABBITMQ_SALES_ERROR_BINDING_KEY',
    ),
